...
# common_voice["train"] = load_dataset(DATASET_STT, "bn", split="train[50%:52%]+validation[50%:52%]", use_auth_token=True)
# common_voice["test"] = load_dataset(DATASET_STT, "bn", split="test[50%:52%]", use_auth_token=True)
